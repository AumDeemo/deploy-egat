              ...
              <tbody>
                <tr v-for="using10000 in paginatedusing10000" key="using10000.id"
                  ...
                  <td data-label="รูปภาพ">
                    <!-- แสดงรูปภาพถ้ามี URL -->
                    <img v-if="using10000.imageUrl" :src="using10000.imageUrl" alt="using10000 Image"
        ...
        <div class="bg-white p-6 rounded-lg w-[800px] max-h-[90vh] overflow-auto shadow-lg relative mx-4">
          ...
          <div class="overflow-x-auto">
            <table class="details-modal w-full text-left border-collapse border border-gray-300">
              ...
              <tbody>
                <tr>
                  <td data-label="ลำดับที่" class="py-2 px-4 border-b">{{ selectedusing10000.number }}</td>
                  <td data-label="รหัสพัสดุ" class="py-2 px-4 border-b">{{ selectedusing10000.curunumber }}</td>
                  <td data-label="รหัสเครื่องมือเครื่องใช้" class="py-2 px-4 border-b">{{ selectedusing10000.partnumber
                    }}</td>
            ...
            <table class="details-modal w-full mt-1 text-left border-collapse border border-gray-300">
              ...
              <tbody>
                <tr>
                  ...
                  <td data-label="วันที่ได้มา" class="py-2 px-4 border-b">
          ...
          <div class="preview-container">
            <!-- รูปภาพ -->
            <img v-if="selectedusing10000.imageUrl" :src="selectedusing10000.imageUrl" alt="Image Preview"
              class="image-preview cursor-pointer" @click="openImageModal(selectedusing10000.imageUrl)" />
          ...
          <div v-if="isImageModalOpen"
            ...
            <img :src="imageModalUrl" alt="Expanded Image" class="max-w-full max-h-full object-contain" />
          </div>
