  ...
  >
      ...
      <div class="flex items-center justify-between max-w-5xl mx-auto flex-nowrap gap-4">
        <div class="flex items-center gap-4">
          <img
            ...
            class="w-16"
          />
          <h1 class="text-2xl font-bold">ระบบจัดการข้อมูลเครื่องมือเครื่องใช้</h1>
        </div>
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="form-control">
          <label class="text-gray-700 font-medium">รหัสพัสดุ</label>
          <input
            v-model="curunumber"
            type="text"
            class="input input-bordered focus:ring focus:ring-blue-300"
        ...
        <div class="form-control">
          <label class="text-gray-700 font-medium">รหัสเครื่องมือเครื่องใช้</label>
          <input
            v-model="partnumber"
            type="text"
            class="input input-bordered focus:ring focus:ring-blue-300"
      ...
      <div class="flex justify-between items-center mt-8">
        <RouterLink to="/admin/crument/using" class="text-blue-600 hover:underline">
          กลับหน้าแรก
        </RouterLink>
        <button
          type="submit"
