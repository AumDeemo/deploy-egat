<template>
    <div class="flex flex-col h-full">
        ...
        <div class="flex">
            ...
            <aside class="w-60 bg-slate-500 rounded-xl h-[600px] hidden sm:block">
                ...
                <div class="h-[60%] flex items-end">
                    <div @click="authStore.logout()"
                        class="bg-red-400 w-full h-20 rounded-b-lg cursor-pointer select-none">
            ...
            <!-- Main Content -->
            <div class="flex-1  rounded-xl mx-auto w-full">
                <div class="flex-col">
                    <div class="bg-yellow-200 w-full h-20 p-5">
                        <p class="text-3xl font-bold">แผนก หบย-ช</p>
                    </div>

                    <div class="bg-green-200 w-full h-10 pt-2 pl-5">
